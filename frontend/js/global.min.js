...
function globalHeaderAnimation() {
  ...
  function heroAnime() {
    const tl = gsap.timeline({ paused: !0, once: !0 });
    ...
    if (images) {
      tl.to(
        images,
        { scale: 1, duration: 1.5, stagger: { amount: 0.3 }, ease: textEase },
        '0.5',
      );
    }
    tl.play();
...
async function globalScrollAnimation() {
  ...
  function fadeupAnime() {
    ...
    allItems.forEach((item) => {
      ...
      createScrollTrigger(item, tl, 'top 75%', 'top bottom', !1);
      tl.from(item, { opacity: 0, y: '2rem', duration: 1.2, ease: textEase });
    });
  }
  function fadeAnime() {
    ...
    allItems.forEach((item) => {
      let tl = gsap.timeline({ paused: !0 });
      createScrollTrigger(item, tl, 'top 75%', 'top bottom', !1);
      tl.from(item, { opacity: 0, duration: 1.2, ease: textEase });
    });
  }
  const html = document.querySelector('html');
  if (html.classList.contains('w-editor')) return;
